...
ExN01DicomIntersectVolume::ExN01DicomIntersectVolume()
 : G4UImessenger(),
   fSolid(0),
   fPhantomVolume(0),
   fRegularParam(0),
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void ExN01DicomIntersectVolume::SetNewValue(G4UIcommand * command,
                                             G4String newValues)    
{ 
  ...
  if (command == fUserVolumeCmd) {
    ...
    if( params.size() < 8 ) {
      G4Exception("ExN01DicomIntersectVolume::SetNewValue",
                  " There must be at least 8 parameters: SOLID_TYPE POS_X POS_Y POS_Z ANG_X ANG_Y ANG_Z SOLID_PARAM_1 (SOLID_PARAM_2 ...)",
    ...
    std::vector<G4String> params = GetWordsInString( newValues );
    if( params.size() !=1 ) G4Exception("ExN01DicomIntersectVolume::SetNewValue",
                                        "",
                                        FatalErrorInArgument,
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void ExN01DicomIntersectVolume::BuildUserSolid( std::vector<G4String> params )
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void ExN01DicomIntersectVolume::BuildG4Solid( std::vector<G4String> params )
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4PhantomParameterisation* ExN01DicomIntersectVolume::GetPhantomParam(G4bool bMustExist)
{
  ...
  if( !paramreg && bMustExist ) 
    G4Exception("ExN01DicomIntersectVolume::GetPhantomParam",
                "",
                FatalErrorInArgument,
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
std::vector<G4VPhysicalVolume*> ExN01DicomIntersectVolume::GetPhysicalVolumes( const G4String& name, bool exists, G4int nVols )
{
  ...
  if( ial != std::string::npos ) {
    ...
    if( ial2 != std::string::npos ) {
      G4Exception("ExN01DicomIntersectVolume::GetPhysicalVolumes",
                  "",
                  FatalErrorInArgument,
  ...
  if( vvolu.size() == 0 ) {
    if(exists) {
      ...
      G4cerr << "!!WARNING: ExN01DicomIntersectVolume::GetPhysicalVolumes: no physical volume found with name " << name << G4endl;
    }
  }

  if( nVols != -1 && G4int(vvolu.size()) != nVols ) {
    G4Exception("ExN01DicomIntersectVolume::GetLogicalVolumes:",
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4bool ExN01DicomIntersectVolume::IsPhantomVolume( G4VPhysicalVolume* pv )
{
  EAxis axis;
  G4int nReplicas;
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
std::vector<G4LogicalVolume*> ExN01DicomIntersectVolume::GetLogicalVolumes( const G4String& name, bool exists, G4int nVols )
{
  ...
  if( vvolu.size() == 0 ) {
    if(exists) {
      G4Exception("ExN01DicomIntersectVolume::GetLogicalVolumes:","",FatalErrorInArgument,("no logical volume found with name " + name).c_str());
    } else {
      G4Exception("ExN01DicomIntersectVolume::GetLogicalVolumes:","",JustWarning,("no  logical volume found with name " + name).c_str());
    }
  }
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
std::vector<G4String> ExN01DicomIntersectVolume::GetWordsInString( const G4String& stemp)
{
