...
ExN01TrackingMessenger::ExN01TrackingMessenger(ExN01TrackingAction* trackA)
:fTrackingAction(trackA)
{
  fTrackingCmd = new G4UIcmdWithABool("/N01/fullChain",this);
...
ExN01TrackingMessenger::~ExN01TrackingMessenger()
{
  delete fTrackingCmd;
}
...
void ExN01TrackingMessenger::SetNewValue(G4UIcommand* command, G4String newValue)
{ 
